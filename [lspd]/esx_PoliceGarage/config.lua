...
Config.PoliceVehicles = {
	{ model = 'cvpileg', label = 'Victoria', price = 0 },
	{ model = 'bikeleg2', label = 'Motor LSPD', price = 0 },
	{ model = 'chargleg', label = 'Charger 18', price = 0 },
	{ model = 'chargleg2', label = 'Charger 14', price = 0 },
	{ model = 'fpiuleg3', label = 'Explorer', price = 0 },
	{ model = 'silvleg', label = 'Silverado', price = 0 },
	{ model = 'taholeg3', label = 'Tahoe', price = 0 }
}
